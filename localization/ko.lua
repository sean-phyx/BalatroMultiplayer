-- TODO: COMPLETE THE KOREAN TRANSLATIONS
return {
	descriptions = {
		Joker = {
			j_mp_defensive_joker = {
				name = "방어적인 조커",
				text = {
					"이 조커가 {C:chips}+#1#{} 개의 칩을",
					"잃어버린 {C:red,E:1}life{}마다 얻습니다",
			...
			j_mp_skip_off = {
				name = "스키프-어프",
				text = {
					"{C:blue}+#1#{} 핸드와 {C:red}+#2#{} 디스카드",
                    "추가적으로 건너뛴 {C:attention}블라인드{}마다",
                    "당신의 {X:purple,C:white}네메시스{}와 비교하여",
